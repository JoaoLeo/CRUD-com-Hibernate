function criarFuncionario(){
    ...
    var idade = document.getElementById("idadeAtt").value
    var foto = document.getElementById("salarioAtt").value   
    var setor = document.getElementById("idSetor").value
    
   

    var urlCriar = "http://localhost:8080/hibernatecrud/rest/funcionario/criar";
    ...
    window.location.href = 'http://localhost:8080/hibernatecrud'
    
}

function listarFuncionarios() {

	const urlListagem = "http://localhost:8080/hibernatecrud/rest/funcionario/listar";
...
function buscarUmFuncionario(id){
	...
	bodyDiv.innerHTML = "";
	var urlBusca = `http://localhost:8080/hibernatecrud/rest/funcionario/buscar/${id}`
...
function pegarSetores(){
    // Retornar os setores
    const urlListagem = "http://localhost:8080/hibernatecrud/rest/setor/listar";
    ...
    request.onload = () => {
        ...
        resposta.forEach(r => {
           bodyHTML += ` <tr>  <td> ${r.id} </td> <td> ${r.nome} </td> </tr>`          	
        });
...
function pegarId(id) {    	
    window.location.href = 'http://localhost:8080/hibernatecrud/pages/funcionario/atualizarFuncionario.html?id=' + id
...
function carregarInformacoes(){
    ...
    var urlListagem = "http://localhost:8080/hibernatecrud/rest/funcionario/buscar/" + id;
	var requestListagem = new XMLHttpRequest();	
	requestListagem.open("GET", urlListagem, true);		
    requestListagem.onload = () =>{
        ...
        res.forEach(r => {
			...
			document.getElementById("idadeAtt").value = r.dtAniversario
			document.getElementById("salarioAtt").value = r.foto
...
function atualizarFuncionario(){
	...
	var idade = document.getElementById("idadeAtt").value
    var salario = document.getElementById("salarioAtt").value   
    var setor = document.getElementById("idSetorAtt").value

    var urlAtualizar = "http://localhost:8080/hibernatecrud/rest/funcionario/atualizar/" + id;
...
function excluirFuncionario(id){
	...
	if(confirmDelete === true){
		const urlDelete = "http://localhost:8080/hibernatecrud/rest/funcionario/excluir/" + id;
